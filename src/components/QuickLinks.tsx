...
export default function QuickLinks() {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 space-y-1.5">
      <p className="text-xs font-medium text-gray-500 px-1.5">常用网站</p>
      {LINKS.map((link) => (
        <a
          key={link.url}
          href={link.url}
          ...
          className="flex items-center gap-2 px-1.5 py-1.5 rounded-lg hover:bg-gray-50 text-sm text-gray-700 transition-colors"
        >
          <span
